...
typedef enum
{
  ...
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST6,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST7,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST8,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST9,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST10,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST11,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST12,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST13,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST14,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST15,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST16,
  RBUS_GTEST_RBUSERROR_TO_STRING_TEST17,
