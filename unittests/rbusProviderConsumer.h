...
typedef enum
{
  ...
  RBUS_GTEST_OPEN_DIRECT_SUBRAWDATA,
  RBUS_GTEST_OPEN_DIRECT,
  RBUS_GTEST_PUBLISH_RAWDATA,
  RBUS_GTEST_PUBLISH_RAWDATA_INVALIDHANDLE,
  RBUS_GTEST_PUBLISH_RAWDATA_NULLEVENTPOINTER,
  RBUS_GTEST_PUBLISH_RAWDATA_NULLRAWDATA,
  RBUS_GTEST_PUBLISH_RAWDATA_NULLZERODATA,
  RBUS_GTEST_PUBLISH_RAWDATA_OVERSIZEDRAWDATA,
  RBUS_GTEST_RBUSERROR_TO_STRING,
